...
import 'package:myhomestay_raya/shared/serverconfig.dart';
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${ServerConfig.SERVER}/assets/productimages/${productList[index].productId}.jpg",
...
//check permission,get location,get address return false if any problem.
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("${ServerConfig.SERVER}/php/product_delete.php"), body: {
